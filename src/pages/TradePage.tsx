...
import { ArrowDown, ArrowRightLeft, Clock, CheckCircle2, XCircle, AlertCircle, Wallet } from 'lucide-react'
...
export default function TradePage() {
  ...
  const rate = useMemo(() => {
    ...
    if (from === 'AIRT' && to === 'USDA') return 1 / 130.00; // Standard conversion
  ...
  return (
    <div className="animate-in fade-in duration-300 relative p-4 md:p-6 text-gray-200 max-w-7xl mx-auto">
      ...
      {showSuccessModal && (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/80 backdrop-blur-sm px-4">
          <div className="bg-[#111827] border border-[#1e2d3d] rounded-2xl p-8 max-w-sm w-full text-center shadow-2xl animate-in zoom-in-95 duration-200">
            ...
            <p className="text-gray-400 text-sm mb-8 leading-relaxed">Your assets have been instantly exchanged in your internal wallet.</p>
            <button
      ...
      <div className="mb-8">
        ...
        <p className="text-gray-500 text-sm mt-1">Instantly exchange assets within your internal wallet with zero network fees.</p>
      </div>
        ...
        <div className="bg-[#0b0f19] border border-[#1e2d3d] rounded-3xl p-6 shadow-xl relative overflow-hidden">
          ...
          <div className="space-y-4 relative z-10">
            ...
            <div className="bg-[#111827] border border-[#1e2d3d] rounded-2xl p-5 transition-colors focus-within:border-blue-500/50">
              ...
              <div className="flex items-center gap-4">
                ...
                <select
                  ...
                  className="bg-[#1e2d3d] text-white font-bold px-4 py-2 rounded-xl outline-none cursor-pointer appearance-none"
                >
            ...
            <div className="bg-[#111827] border border-[#1e2d3d] rounded-xl p-4 flex items-center justify-between mt-2">
              ...
              <span className="text-xs text-emerald-400 font-mono">0 Network Fees</span>
            </div>
